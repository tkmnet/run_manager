...
?>
		<footer class="main-footer">
			...
			<?php } else if ($this->cmd === "runlist") { ?>
				...
				(
				<a href="/app/tkmnet/run_manager-control/getcsv_max/<?= $this->base["name"] ?>">Max</a>
				|
				<a href="/app/tkmnet/run_manager-control/getcsv_mean/<?= $this->base["name"] ?>">Mean</a>
				|
				<a href="/app/tkmnet/run_manager-control/getcsv_median/<?= $this->base["name"] ?>">Median</a>
				)
			<?php } ?>
